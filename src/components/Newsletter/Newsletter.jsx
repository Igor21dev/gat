      ...
      <div className='containerNewsletter'>
        <div className='flex'>
            <div className='mt-[48px] ml-[20px]'>
                <img className='w-[600px]' src={lastFotoCat} alt="" />
            </div>
            <div className='mt-[108px] ml-[20px]'>
            ...
            <div className='campos'>
                <div className="relative mt-[235px] ml-[-20px] w-[473px]">
                    <input 
        ...
        <div className='informacoes mt-[60px] ml-[22px]'>
            <div className='w-[250px] h-full bg-[#373737]'>
                <img className='w-[90px] ml-[75px] transform translate-y-[50px]' src={logoVertical} alt="" />
            </div>
            <div>
                <div className="w-[620px] h-[55px] border border-black ml-[250px] mt-[-222px] flex flex-row justify-evenly items-center font-bold">
                ...
                <div className='flex'>
                    <div className='w-[247px] h-[168px] border border-black ml-[250px] flex flex-row justify-between items-center font-bold'>
                    ...
                    <div className='w-[373px] h-[168px] border border-black flex flex-row justify-between items-center font-bold'>
            ...
            <div className='w-[250px] h-[222px] border border-black ml-[870px] mt-[-223px] flex flex-col ' >
            ...
            <div>
                <div className='w-[345px] h-[222px] border border-black ml-[1120px] mt-[-223px]'>
                    <div className='w-[345px] h-[53%] border border-black  mt-[-1px]'>
                    ...
                    <div className='w-[345px] h-[48%] border border-black'>
        ...
        <div>
            <p className='text-[12px] ml-[22px] mt-[15px]'>© 2024, GAT. TODOS OS DIREITOS RESERVADOS.</p>
            <p className='text-[12px] ml-[860px] mt-[-20px]' >GAT  LTDA. | R. Ondina Carvalheira Peixoto, 300 - Chácaras Palmeiras | Cataguases - MG | CEP 36774-550</p>
        </div>
      </div>
    </div>
  )
