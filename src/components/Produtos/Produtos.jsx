  ...
  return (
    <div>
        <div className='container absolute'>
          <div className='queridinhos absolute transform translate-x-[100px]'>
            <img className=' w-[200px] mt-[2345px] transform translate-x-[-700px]' src={circuloAmarelo} alt="" />
            <p className='textQueridinhos absolute text-[50px] transform translate-x-[-645px] transform translate-y-[-136px] leading-[1.1]'>
            ...
            <button
             onClick={handleClick}
             className={`buttonQueridinhos absolute text-[15px] transform translate-x-[-645px] transform translate-y-[60px] rounded-[30px] border-[2px] border-black
             ${clicked ? 'bg-black text-white' :  'bg-transparent text-black'}`}
            >
              VER TUDO</button>
          </div>
          <div className='cards absolute w-[250px]'>
            <div className='produtoCard absolute w-[340px] h-[516px] mt-[1135px] ml-[-340px]'
              onMouseEnter={() => setIsHovered1(true)}
              onMouseLeave={() => setIsHovered1(false)}
            >
              <div className='containerImg w-full h-3/4 relative'>
                <div className='porcentagem flex justify-end w-[70px] ml-[265px] z-50 absolute'> <span className='font-bold'> 10% </span>OFF</div>
                <div className='lancamento flex justify-end w-[105px] ml-[230px] mt-[35px] font-bold z-50 absolute'>Lançamento</div>
            ...
            <div className='produtoCard absolute w-[340px] h-[516px] mt-[1135px] ml-[15px]'
            ...
            <div className='produtoCard absolute w-[340px] h-[516px] mt-[1135px] ml-[370px]'
